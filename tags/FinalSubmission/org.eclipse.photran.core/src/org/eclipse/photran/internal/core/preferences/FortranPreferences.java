...
public final class FortranPreferences
{
    ...
    // #robins
    public static final FortranBooleanPreference ENABLE_SYNTAX_HIGHLIGHTING = new FortranBooleanPreference("syntaxhighlighting", true); //$NON-NLS-1$
    public static final FortranIntegerPreference SCALABILITY_THRESHOLD = new FortranIntegerPreference("scalabilitythreshold", 25000);  //$NON-NLS-1$
    public static final FortranBooleanPreference SCALABILITY_ENABLE = new FortranBooleanPreference("scalabilityalert", false); //$NON-NLS-1$    
    // end#robins
